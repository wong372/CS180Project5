...
import java.awt.event.*;
/**
 * A second client class the takes in all the user inputs for the quiz program and sends them to the server 
 * for processing. This second class allows for concurent testing.
 *
